package com.qa.practicerediff.listeners;
...
import com.qa.practicerediff.utilities.Practicerediff_ExtentReporter;

public class MyRediffPracticeListeners implements ITestListener {
	...
	try {
		extentReport = Practicerediff_ExtentReporter.generateExtentReport();
	} catch (Exception e) {
		e.printStackTrace();
	}	
